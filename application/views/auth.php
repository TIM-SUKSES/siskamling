  ...
  <div id="beranda" class="section-login">
    <div class="login-container">
      ...
      <div class="login-button">
        ...
        <a href="" data-bs-toggle="modal" data-bs-target="#modal-login-warga"><button class="bg-success"><i class="fa fa-users"> </i> MASUK SEBAGAI WARGA</button></a>
      </div>
    </div>
  </div>
</section>
...
<div class="modal fade" id="modal-login-warga" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-auth">
    <div class="modal-content bg-light">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="<?php echo site_url('auth/login_warga'); ?>" method="post">
          <div class="form-group mb-3">
            <label for="email" class="text-secondary mb-3">EMAIL *</label>
            <input type="email" name="email" id="email" class="form-control" placeholder="Masukkan Email Anda" required>
          </div>
